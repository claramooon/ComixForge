...
function ComicBubble({ bubble, onDelete, onMove, panelRef }) {
  ...
  const DelBtn = () => <button onClick={() => onDelete(bubble.id)} style={{ position:"absolute", top:-9, right:-9, background:"#111", color:"#fff", border:"none", borderRadius:"50%", width:18, height:18, fontSize:10, cursor:"pointer", lineHeight:"18px", padding:0, zIndex:30 }}>✕</button>;
      ...
      {image
        ...
        : <div style={{ display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", height:"100%", gap:10 }}>
            <button onClick={e => { e.stopPropagation(); fileRef.current.click(); }}
              ...
              <span style={{ fontSize:32 }}>🖼️</span>+ ADD IMAGE
            </button>
